...
#Put this line to make the background window to train the BDT-TMVA, include it into TreeDataSelection                                                                      
BkgWindow = '(Bs_M<5200. || Bs_M>5500.)'

TreeDataSelection = [PTCuts, Track_chi2, Pid_kaons, Pid_pions, Trchi2ndof, VetoProtons, KsMass, KsPT, Ks_Vchi2ndof, Ks_DIRA, VetoMuons, BkgWindow]
